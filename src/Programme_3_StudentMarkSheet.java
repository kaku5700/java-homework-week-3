 ...
 * English marks (marks is between 0to100 and if it is out of range print error message “Invalid
 * Input, Marks should between 0to100”) and find out total, percentage and result.
...
public class Programme_3_StudentMarkSheet {
    ...
    public static void main(String[] args) {
        ...
        if (math >= 0 && math <= 100 && sci >= 0 && sci <= 100 && eng >= 0 && eng <= 100) {
            ...
            System.out.println("The marks value should be between 0 to 100. Please Retry.");
        }
        scan.close();
